...
class Ui_signup(object):
    def setupUi(self, signup):
        ...
        self.namee = QtWidgets.QLineEdit(self.frame)
        self.namee.setStyleSheet("background-color: white;\n"
"color: rgb(25, 28, 255);\n"
"border-radius: 40px;")
        self.namee.setObjectName("namee")
        self.horizontalLayout_3.addWidget(self.namee)
...
"border-radius: 40px;")
        ...
        self.horizontalLayout_4.addWidget(self.contact)
...
"border-radius: 40px;")
        ...
        self.horizontalLayout_8.addWidget(self.dept)
...
"border-radius: 40px;")
        ...
        self.image = QtWidgets.QLineEdit(self.frame)
...
"border-radius: 40px;")
    ...
    def form(self):
        ...
        cont = self.contact.text()
        emai = self.email.text()
        sex = self.comboBox_2.currentText()
        club = self.comboBox.currentText()
        year = self.comboBox_3.currentText()
        dept = self.dept.text()
        roll = bool(self.checkBox.isChecked())
        img = self.image.text()
        group = None

        wait_member(username, name, roll, img, cont,year,group,dept,emai,sex,club)
    ...
    def retranslateUi(self, signup):
        ...
        self.namee.setText(_translate("signup", "Name"))
        ...
        self.contact.setText(_translate("signup", "Contact"))
        self.label_8.setText(_translate("signup", "Department"))
        self.dept.setText(_translate("signup", "Department"))
        ...
        self.email.setText(_translate("signup", "Email"))
        ...
        self.image.setText(_translate("signup", "Img"))
